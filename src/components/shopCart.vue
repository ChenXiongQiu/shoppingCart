<template>
    ...
    <div>
                            ...
                            <li v-for="(item,index) in list">
                                <div class="cart-tab-1">
                                    <div class="cart-item-check">
                                        <a href="javascript:void 0" class="item-check-btn" :class="{check:item.isChecked}" @click="selectGood(item)">
                                    ...
                                    <div class="cart-item-pic">
                                        <img :src="item.productImage" @click="selectGood(item,index)">
                                    </div>
                                        ...
                                        <dl>
                                            ...
                                            <dd v-for="part in item.parts">
                                                <div class="partContent">
                                                    <div class="left">
                                                        <span @mouseover="partMouseOver(part)" @mouseout="partMouseOut(part)" v-text="part.partsName"></span>
                                                    </div>
                                                    <div class="right">
                                ...
                                <div class="cart-tab-4">
                                    <div class="item-price-total">{{item.productPrice * item.productQuentity|Currency}}</div>
                                </div>
                                <div class="cart-tab-5">
                                    <div class="cart-item-opration">
                                        <a href="javascript:void 0" class="item-edit-btn" @click="delGood(item,index)">
        ...
        <div class="md-modal modal-msg md-modal-transition" id="showModal" :class="{'md-show':confirmDelete}">
